...
INSERT INTO atividades (id, nome, descricao, distancia, tempo, data, tipoBicicleta, publica, usuario_id)
VALUES
    (1, 'Corrida 1', 'Corrida 1 teste pro banco', 10, 21, '2025-10-10', 1, TRUE, 1);
